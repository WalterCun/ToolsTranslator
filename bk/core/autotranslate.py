...
from bk.parses.tjson import JSON

from bk.utils import TranslateFile
from bk.utils.extract_info_file import extract_first_primitive_value
...
try:
    if importlib.util.find_spec('yaml'):
        from bk.parses.tyaml import YAML
except ImportError:
    YAML = None
