...
from translator.managers.docker_manager import CheckResult, DockerManager
...
def restart() -> None:
    ...
    typer.secho(f"  → Ejecuta `translator install` para recrearlo si es necesario.", fg=typer.colors.YELLOW)
    raise typer.Exit(code=1)
