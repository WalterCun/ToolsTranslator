    ...
    def diagnostics(self) -> list[CheckResult]:
        ...
        checks.append(
            CheckResult(
                ...
                suggestion="Inicia Docker service/Desktop y vuelve a ejecutar `translator doctor`.",
            )
        )
        ...
        checks.append(
            CheckResult(
                ...
                suggestion=f"Ejecuta `docker pull {self.image}` o `translator install`.",
            )
        )
        ...
        checks.append(
            CheckResult(
                ...
                suggestion=f"Ejecuta `translator install` para crearlo.",
            )
        )
        checks.append(
            CheckResult(
                ...
                suggestion=f"Ejecuta `docker start {self.container_name}` o `translator install`.",
            )
        )
